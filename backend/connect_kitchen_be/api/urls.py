...
from .views import register_view, login_view, profile_view, add_post_view, get_jobs, save_job_view, delete_saved_job_view, get_saved_jobs_view, get_job_by_id, save_proposal, get_proposals_by_job, get_proposals_by_user, get_jobs_by_user,get_proposal_by_id, update_proposal_acceptance, hire_proposal, get_hired_chef, complete_job, upload, get_profile_image,get_top_chefs, add_review_rating, delete_job
...
urlpatterns = [
    ...
    path('top-chefs/', get_top_chefs, name='get_top_chefs'),
    path('giveRating/', add_review_rating, name='add_review_rating')
